...
export default function App() {
  // Input form state
  const [subject, setSubject] = useState<string>("정보");
  const [customSubject, setCustomSubject] = useState<string>("");
  const [grade, setGrade] = useState<string>("중학교 1~3학년군");
            ...
            <div className="grid grid-cols-2 gap-3" id="meta_inputs">
              <div className="flex flex-col gap-1.5">
                ...
                <select
                  ...
                  className="bg-slate-50 border border-slate-200 text-slate-800 rounded-xl px-2 py-2 text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white"
                >
                  <optgroup label="기초 핵심 교과">
                  ...
                  <optgroup label="지원 강화! 기타 선택/융합/예체능 교과">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                >
                  ...
                  <option value="고등학교 (공통과목)">고등학교 (공통과목)</option>
                  <option value="고등학교 (선택/융합선택과목)">고등학교 (선택/융합선택과목)</option>
                  <option value="기타">기타 (직접 입력)</option>
                </select>
              </div>
            </div>
